...
orthoKMeansTrainCpp <- function(x, rounds = 1L, k = 3L, iter = 100L, initType = 0L, verbose = FALSE) {
    .Call('_yakmoR_orthoKMeansTrainCpp', PACKAGE = 'yakmoR', x, rounds, k, iter, initType, verbose)
}
...
orthoKMeansPredictCpp <- function(x, centers, nf, k = 0L, verbose = FALSE) {
    .Call('_yakmoR_orthoKMeansPredictCpp', PACKAGE = 'yakmoR', x, centers, nf, k, verbose)
}
