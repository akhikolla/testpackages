...
RcppExport SEXP _rplum_bacon(SEXP inputfile1SEXP, SEXP outputfile1SEXP, SEXP ssizeSEXP, SEXP dirccSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _rplum_events(SEXP th1SEXP, SEXP th2SEXP, SEXP th_shiftSEXP, SEXP windowSEXP, SEXP outputfname1SEXP, SEXP MCMCsamplesfname1SEXP, SEXP samplesizeSEXP, SEXP KSEXP, SEXP c0SEXP, SEXP DcSEXP, SEXP eventprobsfname1SEXP, SEXP depths_sizeSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_rplum_bacon", (DL_FUNC) &_rplum_bacon, 4},
    {"_rplum_events", (DL_FUNC) &_rplum_events, 12},
    {NULL, NULL, 0}
};

RcppExport void R_init_rplum(DllInfo *dll) {
