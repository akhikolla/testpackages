...
namespace model_cbqrandomb_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cbqrandomb");
    reader.add_event(50, 48, "end", "model_cbqrandomb");
    return reader;
}
...
class model_cbqrandomb
  : public stan::model::model_base_crtp<model_cbqrandomb> {
private:
        int N;
        int D;
        vector_d Y;
        ...
        double q;
public:
    model_cbqrandomb(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cbqrandomb_namespace::model_cbqrandomb";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_cbqrandomb_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_cbqrandomb_namespace::model_cbqrandomb stan_model;
#ifndef USING_R
