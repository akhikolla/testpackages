...
namespace model_cbqdv_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cbqdv");
    reader.add_event(109, 107, "end", "model_cbqdv");
    return reader;
}
...
class model_cbqdv
  : public stan::model::model_base_crtp<model_cbqdv> {
private:
        int N;
        int D_common;
        vector_d Y;
...
public:
    model_cbqdv(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cbqdv_namespace::model_cbqdv";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_cbqdv_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_cbqdv_namespace::model_cbqdv stan_model;
#ifndef USING_R
