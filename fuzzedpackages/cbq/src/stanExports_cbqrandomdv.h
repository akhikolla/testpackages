...
namespace model_cbqrandomdv_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cbqrandomdv");
    reader.add_event(137, 135, "end", "model_cbqrandomdv");
    return reader;
}
...
class model_cbqrandomdv
  : public stan::model::model_base_crtp<model_cbqrandomdv> {
private:
        int N;
        int D_common;
        vector_d Y;
...
public:
    model_cbqrandomdv(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cbqrandomdv_namespace::model_cbqrandomdv";
...
typedef model_cbqrandomdv_namespace::model_cbqrandomdv stan_model;
#ifndef USING_R
