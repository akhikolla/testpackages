...
namespace model_cbqrandombv_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cbqrandombv");
    reader.add_event(50, 48, "end", "model_cbqrandombv");
    return reader;
}
...
class model_cbqrandombv
  : public stan::model::model_base_crtp<model_cbqrandombv> {
private:
        int N;
        int D;
        vector_d Y;
        ...
        double q;
public:
    model_cbqrandombv(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cbqrandombv_namespace::model_cbqrandombv";
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(Y, i, "Y", 1), 1))) {
                    ...
                    stan::math::assign(lik, ((1 - pald2(-((dot_product(stan::model::rvalue(X, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X"), beta) + get_base1(beta_ind, get_base1(person, i, "person", 1), "beta_ind", 1))), q, pstream__)) + offset));
                }
                current_statement_begin__ = 41;
                if (as_bool(logical_eq(get_base1(Y, i, "Y", 1), 0))) {
                    current_statement_begin__ = 42;
                    stan::math::assign(lik, (pald2(-((dot_product(stan::model::rvalue(X, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X"), beta) + get_base1(beta_ind, get_base1(person, i, "person", 1), "beta_ind", 1))), q, pstream__) + offset));
                }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_cbqrandombv_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_cbqrandombv_namespace::model_cbqrandombv stan_model;
#ifndef USING_R
