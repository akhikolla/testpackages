...
namespace model_cbqbv_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cbqbv");
    reader.add_event(48, 46, "end", "model_cbqbv");
    return reader;
}
...
class model_cbqbv
  : public stan::model::model_base_crtp<model_cbqbv> {
private:
        int N;
        int D;
        vector_d Y;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cbqbv_namespace::model_cbqbv";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_cbqbv_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_cbqbv_namespace::model_cbqbv stan_model;
#ifndef USING_R
