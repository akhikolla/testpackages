...
namespace model_cbqpanelb_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cbqpanelb");
    reader.add_event(56, 54, "end", "model_cbqpanelb");
    return reader;
}
...
class model_cbqpanelb
  : public stan::model::model_base_crtp<model_cbqpanelb> {
private:
        int N;
        int D;
        vector_d Y;
        ...
        std::vector<int> wave;
public:
    model_cbqpanelb(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cbqpanelb_namespace::model_cbqpanelb";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_cbqpanelb_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_cbqpanelb_namespace::model_cbqpanelb stan_model;
#ifndef USING_R
