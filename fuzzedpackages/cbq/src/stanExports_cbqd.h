...
namespace model_cbqd_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cbqd");
    reader.add_event(109, 107, "end", "model_cbqd");
    return reader;
}
...
class model_cbqd
  : public stan::model::model_base_crtp<model_cbqd> {
private:
        int N;
        int D_common;
        vector_d Y;
...
public:
    model_cbqd(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cbqd_namespace::model_cbqd";
        ...
        try {
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                stan::model::assign(xb_common, 
                            ...
                            multiply(stan::model::rvalue(X_common, stan::model::cons_list(stan::model::index_uni(i), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), "X_common"), beta), 
            ...
            for (int i = 1; i <= N_indx; ++i) {
                ...
                stan::math::assign(lik2, ((rising_factorial(get_base1(n_group, i, "n_group", 1), 0) * (lik + offset)) * lik3));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_cbqd_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_cbqd_namespace::model_cbqd stan_model;
#ifndef USING_R
