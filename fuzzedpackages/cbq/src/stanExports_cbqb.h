...
namespace model_cbqb_namespace {
using std::istream;
using std::string;
...
class model_cbqb
  : public stan::model::model_base_crtp<model_cbqb> {
private:
        int N;
        int D;
        vector_d Y;
        ...
        double q;
public:
    model_cbqb(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cbqb_namespace::model_cbqb";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_cbqb_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_cbqb_namespace::model_cbqb stan_model;
#ifndef USING_R
