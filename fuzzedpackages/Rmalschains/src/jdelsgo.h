 ...
 */
class JDE : public ClassEAlgorithm {
   private:
       /**
	...
	*/
       string getStrategy(unsigned iteration, unsigned maxFES);

   public:
       JDE(Random *random, int reduced=0);
    ...
    private:
         ...
         */
        void jDE(const int i, const int NP, tIndividualRealJDE* &newsol, tChromosomeReal &best, string strategy, int it, int MaxFES);
private:
        /**
