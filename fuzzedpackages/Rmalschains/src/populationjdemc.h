...
#ifndef _INDIVIDUALJDEMC_H

#define _INDIVIDUALJDEMC_H 1
...
class tIndividualRealJDEMC : public tIndividualReal {
public:
    tIndividualRealJDEMC (const tChromosomeReal &com);
    tIndividualRealJDEMC (const tChromosomeReal &com, double fitness);
    virtual ~tIndividualRealJDEMC(void);
 ...
 * binary Codification
 */
class PopulationRealJDEMC : public PopulationReal {
   public:
    PopulationRealJDEMC(Random *random,unsigned int max, unsigned int pob);
