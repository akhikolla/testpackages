...
#ifndef _INDIVIDUALJDERAND_H

#define _INDIVIDUALJDERAND_H 1
...
class tIndividualRealJDERand : public tIndividualReal {
public:
    tIndividualRealJDERand (const tChromosomeReal &com);
    tIndividualRealJDERand (const tChromosomeReal &com, double fitness);
    virtual ~tIndividualRealJDERand(void);
 ...
 * binary Codification
 */
class PopulationRealJDERand : public PopulationReal {
   public:
    PopulationRealJDERand(Random *random,unsigned int max, unsigned int pob);
