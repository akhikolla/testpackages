...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_qmixbfv");
    reader.add_event(70, 68, "end", "model_qmixbfv");
    return reader;
}
...
class model_qmixbfv
  : public stan::model::model_base_crtp<model_qmixbfv> {
private:
        int N;
        int D;
        vector_d Y;
...
typedef model_qmixbfv_namespace::model_qmixbfv stan_model;
#ifndef USING_R
