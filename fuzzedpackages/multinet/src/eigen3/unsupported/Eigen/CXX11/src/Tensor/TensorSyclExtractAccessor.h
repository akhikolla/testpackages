...
{
    template<typename Arg> static inline auto
    getTuple(cl::sycl::handler& cgh, Arg eval)
    -> decltype(ExtractAccessor<Arg>::getTuple(cgh, eval))
    {
        return ExtractAccessor<Arg>::getTuple(cgh, eval);
    }

    template<typename Arg1, typename Arg2> static inline auto
    getTuple(cl::sycl::handler& cgh, Arg1 eval1, Arg2 eval2)
    ...
    template<typename Arg1, typename Arg2, typename Arg3>	static inline auto
    ...
    template< cl::sycl::access::mode AcM, typename Arg> static inline auto
    getAccessor(cl::sycl::handler& cgh, Arg eval)
...
{
    static inline auto
    getTuple(cl::sycl::handler& cgh, const TensorEvaluator<const UnaryCategory<OP, RHSExpr>, Dev> eval)
...
{
    static inline auto
    getTuple(cl::sycl::handler& cgh, const TensorEvaluator<const BinaryCategory<OP, LHSExpr, RHSExpr>, Dev> eval)
...
{
    static inline auto
    getTuple(cl::sycl::handler& cgh, const TensorEvaluator<const TernaryCategory<OP, Arg1Expr, Arg2Expr, Arg3Expr>, Dev> eval)
...
{
    static inline auto
    getTuple(cl::sycl::handler& cgh, const TensorEvaluator<const TensorSelectOp<IfExpr, ThenExpr, ElseExpr>, Dev> eval)
...
{
    static inline auto
    getTuple(cl::sycl::handler& cgh, const TensorEvaluator<const TensorAssignOp<LHSExpr, RHSExpr>, Dev> eval)
    -> decltype(AccessorConstructor::getTuple(cgh, eval.left_impl(), eval.right_impl()))
    {
        return AccessorConstructor::getTuple(cgh, eval.left_impl(), eval.right_impl());
    }
...
{
    static inline auto
    getTuple(cl::sycl::handler& cgh, const TensorEvaluator<const TensorForcedEvalOp<Expr>, Dev> eval)
...
{
    static inline auto
    getTuple(cl::sycl::handler& cgh,const TensorEvaluator<const TensorEvalToOp<Expr>, Dev> eval)
...
{
    static inline auto
    getTuple(cl::sycl::handler& cgh, const TensorEvaluator<const TensorReductionOp<OP, Dim, Expr>, Dev> eval)
    -> decltype(AccessorConstructor::template getAccessor<cl::sycl::access::mode::read>(cgh, eval))
    {
        return AccessorConstructor::template getAccessor<cl::sycl::access::mode::read>(cgh, eval);
    }
...
template <typename Evaluator>
auto
createTupleOfAccessors(cl::sycl::handler& cgh, const Evaluator& expr)
