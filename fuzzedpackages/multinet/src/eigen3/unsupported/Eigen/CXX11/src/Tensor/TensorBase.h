...
class TensorBase<Derived, ReadOnlyAccessors>
{
  public:
    ...
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    const TensorCustomUnaryOp<const CustomUnaryFunc, const Derived>
    customOp(const CustomUnaryFunc& op) const
    {
  ...
  protected:
    ...
    EIGEN_DEVICE_FUNC
    EIGEN_STRONG_INLINE const Derived&
    derived() const
    {
...
class TensorBase : public TensorBase<Derived, ReadOnlyAccessors>
{
  public:
    ...
    TensorDevice<Derived, DeviceType>
    device(const DeviceType& device)
    {
