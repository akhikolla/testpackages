...
class Tensor : public TensorBase<Tensor<Scalar_, NumIndices_, Options_, IndexType_> >
{
  ...
  public:
    ...
    void
    resize(Index firstDimension, IndexTypes... otherDimensions)
    {
    ...
    resize(const array<Index, NumIndices>& dimensions)
    {
        int i;
        Index size = Index(1);
    ...
    EIGEN_DEVICE_FUNC void
    resize(const DSizes<Index, NumIndices>& dimensions)
    {
    ...
    EIGEN_DEVICE_FUNC
    void
    resize(const Sizes<Indices...>& dimensions)
    {
        array<Index, NumIndices> dims;
    ...
    EIGEN_DEVICE_FUNC
    void
    resize(const Sizes<V1, V2, V3, V4, V5>& dimensions)
    {
        array<Index, NumIndices> dims;
