...
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
double2 pzeta<double2>
(const double2& x, const double2& q)
{
    using numext::zeta;
...
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
float4 ppolygamma<float4>
(const float4& n, const float4& x)
{
...
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
double2 ppolygamma<double2>
(const double2& n, const double2& x)
{
    using numext::polygamma;
...
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
double2 pigamma<double2>
(const double2& a, const double2& x)
{
    using numext::igamma;
...
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
float4 pbetainc<float4>
(const float4& a, const float4& b, const float4& x)
{
...
template<> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
double2 pbetainc<double2>
(const double2& a, const double2& b, const double2& x)
{
    using numext::betainc;
