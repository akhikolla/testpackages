...
class HybridNonLinearSolver
{
  public:
    ...
    HybridNonLinearSolverSpace::Status
    solveInit(FVectorType  &x);
    HybridNonLinearSolverSpace::Status
    solveOneStep(FVectorType  &x);
    HybridNonLinearSolverSpace::Status
    solve(FVectorType  &x);
    ...
    HybridNonLinearSolverSpace::Status
    solveNumericalDiffInit(FVectorType  &x);
    HybridNonLinearSolverSpace::Status
    solveNumericalDiffOneStep(FVectorType  &x);
    HybridNonLinearSolverSpace::Status
    solveNumericalDiff(FVectorType  &x);
  ...
  private:
    ...
    operator=(const HybridNonLinearSolver&);
};
