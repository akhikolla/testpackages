    ...
    : public ProductBase<BlockSparseTimeDenseProduct<Lhs,Rhs>, Lhs, Rhs>
{
  public:
    ...
    scaleAndAddTo(Dest& dest, const typename Rhs::Scalar& alpha) const
    {
  ...
  private:
    ...
    operator=(const BlockSparseTimeDenseProduct&);
};
...
class BlockSparseMatrix : public SparseMatrixBase<BlockSparseMatrix<_Scalar,_BlockAtCompileTime, _Options,_StorageIndex> >
{
  ...
  public:
    ...
    friend void
    swap(BlockSparseMatrix& first, BlockSparseMatrix& second)
    {
    ...
    BlockSparseMatrix&
    operator=(BlockSparseMatrix other)
    {
    ...
    inline
    BlockSparseMatrix(const MatrixType& spmat) : m_blockSize(BlockSize)
    {
    ...
    operator=(const MatrixType& spmat)
    {
    ...
    template<typename MatrixType>
    void
    setBlockStructure(const MatrixType& blockPattern)
    {
    ...
    /**
      ...
      */
    inline void
    setBlockLayout(const VectorXi& rowBlocks, const VectorXi& colBlocks)
    {
    ...
    /**
      ...
      */
    inline void
    reserve(const Index nonzerosblocks)
    {
        eigen_assert((m_innerBSize != 0 && m_outerBSize != 0) &&
    ...
    void
    setFromTriplets(const InputIterator& begin, const InputIterator& end)
    {
    ...
    inline Index
    outerToBlock(Index outer) const
    {
    ...
    inline Index
    innerToBlock(Index inner) const
    {
    ...
    /**
      ...
      */
    Map<const BlockScalar>
    coeff(Index brow, Index bcol) const
    {
        eigen_assert(brow < blockRows() && "BLOCK ROW INDEX OUT OF BOUNDS");
    ...
    friend std::ostream &
    operator << (std::ostream & s, const BlockSparseMatrix& m)
    {
