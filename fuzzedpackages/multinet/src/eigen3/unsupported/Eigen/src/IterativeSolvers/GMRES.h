...
bool
gmres(const MatrixType & mat, const Rhs & rhs, Dest & x, const Preconditioner & precond,
...
class GMRES : public IterativeSolverBase<GMRES<_MatrixType,_Preconditioner> >
{
  ...
  public:
    ...
    explicit
    GMRES(const EigenBase<MatrixDerived>& A) : Base(A.derived()), m_restart(30) {}
    ...
    /** Set the number of iterations after that a restart is performed.
      ...
      */
    void
    set_restart(const Index restart)
    {
        m_restart=restart;
    }
