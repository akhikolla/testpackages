...
struct SplineFitting
{
    ...
    static SplineType
    InterpolateWithDerivatives(const PointArrayType& points,
...
template <typename PointArrayType>
SplineType
SplineFitting<SplineType>::Interpolate(const PointArrayType& pts, DenseIndex degree, const KnotVectorType& knot_parameters)
{
