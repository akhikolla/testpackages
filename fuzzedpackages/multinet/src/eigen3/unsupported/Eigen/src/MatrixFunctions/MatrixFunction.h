...
void
matrix_function_compute_permutation(const DynVectorType& blockStart, const DynVectorType& eivalToCluster, VectorType& permutation)
{
...
void
matrix_function_compute_above_diagonal(const MatrixType& T, const VectorType& blockStart, const VectorType& clusterSize, MatrixType& fT)
{
...
struct matrix_function_compute
{
    ...
    static void
    run(const MatrixType& A, AtomicType& atomic, ResultType &result);
};
