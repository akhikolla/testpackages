    ...
    : public SparseCompressedBase<SparseMatrix<_Scalar, _Options, _StorageIndex> >
{
  ...
  public:
    ...
    template<class SizesType>
    inline void
    reserve(const SizesType& reserveSizes, const typename SizesType::value_type& enableif =
  ...
  public:
    ...
    void
    setFromTriplets(const InputIterators& begin, const InputIterators& end, DupFunctor dup_func);
...
template<typename InputIterators,typename DupFunctor>
void
SparseMatrix<Scalar,_Options,_StorageIndex>::setFromTriplets(const InputIterators& begin, const InputIterators& end, DupFunctor dup_func)
{
    ...
    : evaluator<SparseCompressedBase<SparseMatrix<_Scalar,_Options,_StorageIndex> > >
{
    ...
    evaluator() : Base() {}
    explicit
    evaluator(const SparseMatrixType &mat) : Base(mat) {}
};
