    ...
    : public SparseCompressedBase<Derived>
{
  ...
  public:
    ...
    inline
    SparseMapBase(Index rows, Index cols, Index nnz, IndexPointer outerIndexPtr, IndexPointer innerIndexPtr,
    ...
    : public SparseMapBase<Derived,ReadOnlyAccessors>
{
  ...
  public:
    ...
    inline
    SparseMapBase(Index rows, Index cols, Index nnz, StorageIndex* outerIndexPtr, StorageIndex* innerIndexPtr,
...
#endif
{
  ...
  public:
    ...
    /** Constructs a read-write Map to a sparse matrix of size \a rows x \a cols, containing \a nnz non-zero coefficients,
      ...
      */
    inline
    Map(Index rows, Index cols, Index nnz, StorageIndex* outerIndexPtr,
    ...
    : public SparseMapBase<Map<const SparseMatrix<MatScalar,MatOptions,MatIndex>, Options, StrideType> >
{
  ...
  public:
    ...
    /** This is the const version of the above constructor.
      ...
      */
    inline
    Map(Index rows, Index cols, Index nnz, const StorageIndex* outerIndexPtr,
    ...
    : evaluator<SparseCompressedBase<Map<SparseMatrix<MatScalar,MatOptions,MatIndex>, Options, StrideType> > >
{
    ...
    evaluator() : Base() {}
    explicit
    evaluator(const XprType &mat) : Base(mat) {}
};
