...
EIGEN_DEVICE_FUNC
inline ConstRowsBlockXpr
middleRows(Index startRow, Index n) const
{
...
EIGEN_DEVICE_FUNC
inline ConstColsBlockXpr
middleCols(Index startCol, Index numCols) const
{
