...
class ParametrizedLine
{
  public:
    ...
    ParametrizedLine(Index _dim) : m_origin(_dim), m_direction(_dim) {}
...
template <int OtherOptions>
EIGEN_DEVICE_FUNC inline
ParametrizedLine<_Scalar, _AmbientDim,_Options>::ParametrizedLine(const Hyperplane<_Scalar, _AmbientDim,OtherOptions>& hyperplane)
{
