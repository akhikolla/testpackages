...
class QuaternionBase : public RotationBase<Derived, 3>
{
  public:
    ...
    template<class OtherDerived> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Derived&
    ...
    */
    ...
    template<class OtherDerived> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE Quaternion<Scalar>
...
struct quaternionbase_assign_impl<Other,3,3>
{
    ...
    template<class Derived> EIGEN_DEVICE_FUNC static inline void
