...
template<typename T, int Value> class variable_if_dynamic
{
  public:
    ...
    EIGEN_DEVICE_FUNC static EIGEN_STRONG_INLINE T
    value()
    {
        return T(Value);
    }
...
template<typename T> class variable_if_dynamic<T, Dynamic>
{
  ...
  public:
    ...
    variable_if_dynamic(T value) : m_value(value) {}
...
template<typename T> class variable_if_dynamicindex<T, DynamicIndex>
{
  ...
  public:
    EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE explicit
    variable_if_dynamicindex(T value) : m_value(value) {}
...
template<typename T1, typename T2>
bool
is_same_dense(const T1 &mat1, const T2 &mat2, typename enable_if<has_direct_access<T1>::ret&&has_direct_access<T2>::ret, T1>::type * = 0)
{
...
template<typename T1, typename T2>
bool
is_same_dense(const T1 &, const T2 &, typename enable_if<!(has_direct_access<T1>::ret&&has_direct_access<T2>::ret), T1>::type * = 0)
{
    return false;
}
