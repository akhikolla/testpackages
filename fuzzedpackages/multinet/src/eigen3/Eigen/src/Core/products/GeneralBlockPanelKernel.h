...
{
    EIGEN_ALWAYS_INLINE static void
    run(const CJ& cj, A& a, B& b, C& c, T& /*t*/)
    {
        c = cj.pmadd(a,b,c);
    }
};
...
gebp_madd(const CJ& cj, A& a, B& b, C& c, T& t)
{
...
class gebp_traits<std::complex<RealScalar>, RealScalar, _ConjLhs, false>
{
  public:
    ...
    EIGEN_STRONG_INLINE void
    loadLhsUnaligned(const LhsScalar* a, LhsPacket& dest) const
    {
...
class gebp_traits<std::complex<RealScalar>, std::complex<RealScalar>, _ConjLhs, _ConjRhs >
{
  public:
    ...
    // Scalar path
    EIGEN_STRONG_INLINE void
    loadRhs(const RhsScalar* b, ResPacket& dest) const
    {
    ...
    // Vectorized path
    EIGEN_STRONG_INLINE void
    loadRhs(const RhsScalar* b, DoublePacketType& dest) const
    {
