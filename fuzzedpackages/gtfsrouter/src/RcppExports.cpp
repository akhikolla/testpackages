...
// rcpp_csa_matrix
Rcpp::DataFrame rcpp_csa_matrix(Rcpp::DataFrame timetable, Rcpp::DataFrame transfers, const size_t nstations, const size_t ntrips, const std::vector <size_t> start_stations, const std::vector <size_t> end_stations, const int start_time, const int max_transfers);
RcppExport SEXP _gtfsrouter_rcpp_csa_matrix(SEXP timetableSEXP, SEXP transfersSEXP, SEXP nstationsSEXP, SEXP ntripsSEXP, SEXP start_stationsSEXP, SEXP end_stationsSEXP, SEXP start_timeSEXP, SEXP max_transfersSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::DataFrame >::type timetable(timetableSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(rcpp_csa_matrix(timetable, transfers, nstations, ntrips, start_stations, end_stations, start_time, max_transfers));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_make_timetable
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_gtfsrouter_rcpp_csa_matrix", (DL_FUNC) &_gtfsrouter_rcpp_csa_matrix, 8},
