...
bpp_solver_dpp_wrapper <- function(it, bn) {
    .Call('_gbp_bpp_solver_dpp_wrapper', PACKAGE = 'gbp', it, bn)
}
...
gbp2d_solver_dpp_prep_create_p <- function(ld, m) {
    .Call('_gbp_gbp2d_solver_dpp_prep_create_p', PACKAGE = 'gbp', ld, m)
}
...
gbp3d_solver_dpp_prep_create_p <- function(ldh, m) {
    .Call('_gbp_gbp3d_solver_dpp_prep_create_p', PACKAGE = 'gbp', ldh, m)
}
...
gbp4d_solver_dpp_prep_create_p <- function(ldhw, m) {
    .Call('_gbp_gbp4d_solver_dpp_prep_create_p', PACKAGE = 'gbp', ldhw, m)
}
