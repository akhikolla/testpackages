...
#include "stanExports_multresponse_continuous.h"

RCPP_MODULE(stan_fit4multresponse_continuous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_multresponse_continuous")
