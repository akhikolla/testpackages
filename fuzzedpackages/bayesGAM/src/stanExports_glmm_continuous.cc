...
#include "stanExports_glmm_continuous.h"

RCPP_MODULE(stan_fit4glmm_continuous_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_glmm_continuous")
