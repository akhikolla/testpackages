...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_VIB");
    reader.add_event(75, 73, "end", "model_VIB");
    return reader;
}
#include <stan_meta_header.hpp>
class model_VIB
  : public stan::model::model_base_crtp<model_VIB> {
private:
        int N;
        vector_d y;
        int K;
        ...
        double hyper_phi;
public:
    model_VIB(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_VIB_namespace::model_VIB";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_VIB_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_VIB_namespace::model_VIB stan_model;
#ifndef USING_R
