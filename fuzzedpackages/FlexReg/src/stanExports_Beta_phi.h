...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_Beta_phi");
    reader.add_event(72, 70, "end", "model_Beta_phi");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Beta_phi
  : public stan::model::model_base_crtp<model_Beta_phi> {
private:
        int N;
        vector_d y;
        int K;
...
public:
    model_Beta_phi(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_Beta_phi_namespace::model_Beta_phi";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_Beta_phi_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_Beta_phi_namespace::model_Beta_phi stan_model;
#ifndef USING_R
