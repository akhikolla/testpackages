...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_VIB_phi");
    reader.add_event(87, 85, "end", "model_VIB_phi");
    return reader;
}
#include <stan_meta_header.hpp>
class model_VIB_phi
  : public stan::model::model_base_crtp<model_VIB_phi> {
private:
        int N;
        vector_d y;
        int K;
...
public:
    model_VIB_phi(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_VIB_phi_namespace::model_VIB_phi";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_VIB_phi_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_VIB_phi_namespace::model_VIB_phi stan_model;
#ifndef USING_R
