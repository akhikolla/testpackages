...
#' @source \url{https://www.cs.ucr.edu/~eamonn/time_series_data_2018/}
NULL
...
#' @name abalone
#' @usage data(abalone)
#' @format Predict the age of abalone from physical measurements
#' @source \url{https://archive.ics.uci.edu/ml/datasets/Abalone}
NULL
...
#' @name breast
#' @usage data(breast)
#' @format : Diagnostic Wisconsin Breast Cancer Database
