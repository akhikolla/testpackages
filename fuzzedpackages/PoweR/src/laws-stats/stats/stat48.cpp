...
extern "C" {
  ...
  void stat48(double *x, int *xlen, double *level, int *nblevel, char **name, int *getname, double *statistic, int *pvalcomp, double *pvalue, double *critvalL, double *critvalR, int *usecrit, int *alter, int *decision, double *paramstat, int *nbparamstat) {
...
// Computation of the value of the test statistic
    ...
    double *Y;
    Y = new double[n];
    double statT1na, tmp = 0.0, bhat, muhat, sumM1 = 0.0, sumM2 = 0.0;
