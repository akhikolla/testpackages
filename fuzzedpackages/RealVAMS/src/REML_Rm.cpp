#include <RcppArmadillo.h>
   //the arguments of this function are described in the R code;
   RcppExport SEXP REML_Rm_cpp(SEXP invsqrtW_, SEXP JYp_, SEXP loopsize_,
      ...
      SEXP JZpi_, SEXP JZpp_, SEXP JZpx_, SEXP JZpdim_, SEXP betacov_, SEXP C12_) {
	  ...
	  arma::mat betacov = Rcpp::as < arma::mat > (betacov_);
	  arma::mat C12 = Rcpp::as < arma::mat > (C12_);
      ...
      for (int i = 0; i < loopsize; i++) {
         ...
         patternsum += W * (tempt * tempt.t() - tempt * (JZt * etahat).t() - JZt * etahat * tempt.t() + 
           JZt * tempmatR * JZt.t() + JXt * betacov * JXt.t() + JXt * C12 * JZt.t() + JZt * C12.t() * JXt.t()) * W;
