...
countlines <- function(fn) {
    .Call('_collUtils_countlines', PACKAGE = 'collUtils', fn)
}
...
#' @export
ncols <- function(fn) {
    .Call('_collUtils_ncols', PACKAGE = 'collUtils', fn)
}
...
readcol <- function(fileName, colNum, nSkip, maxRowNum) {
    .Call('_collUtils_readcol', PACKAGE = 'collUtils', fileName, colNum, nSkip, maxRowNum)
}
...
readcols <- function(fn, colsel, nFirstSkipLines, nSkipUnit) {
    .Call('_collUtils_readcols', PACKAGE = 'collUtils', fn, colsel, nFirstSkipLines, nSkipUnit)
}
