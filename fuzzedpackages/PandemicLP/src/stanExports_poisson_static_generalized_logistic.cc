...
#include "stanExports_poisson_static_generalized_logistic.h"

RCPP_MODULE(stan_fit4poisson_static_generalized_logistic_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_poisson_static_generalized_logistic")
