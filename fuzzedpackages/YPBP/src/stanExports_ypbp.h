...
namespace model_ypbp_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ypbp");
    ...
    reader.add_event(173, 2, "restart", "model_ypbp");
    reader.add_event(225, 52, "end", "model_ypbp");
    return reader;
}
...
class model_ypbp
  : public stan::model::model_base_crtp<model_ypbp> {
private:
        int n;
        int m;
        int q;
        ...
        int approach;
public:
    model_ypbp(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ypbp_namespace::model_ypbp";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(M, 1))) {
                ...
                stan::math::assign(loglik, loglik1_bp(status, Z, g, G, tau, gamma, psi, phi, pstream__));
            } else {
                current_statement_begin__ = 207;
                stan::math::assign(loglik, loglik2_bp(status, Z, g, G, tau, gamma, psi, phi, pstream__));
            }
            ...
            if (as_bool(logical_eq(approach, 1))) {
                ...
                lp_accum__.add(normal_log<propto__>(psi, 0, sigma_psi));
                current_statement_begin__ = 217;
                lp_accum__.add(normal_log<propto__>(phi, 0, sigma_phi));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ypbp_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_ypbp_namespace::model_ypbp stan_model;
#ifndef USING_R
