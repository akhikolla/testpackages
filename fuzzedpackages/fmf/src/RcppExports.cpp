...
RcppExport SEXP _fmf_knn_index_dist_rcpp(SEXP MATRIXSEXP, SEXP TEST_DATASEXP, SEXP kSEXP, SEXP methodSEXP, SEXP threadsSEXP, SEXP epsSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _fmf_DIST_MATRIX_knn(SEXP DIST_MATSEXP, SEXP TEST_IDXSEXP, SEXP is_minSEXP, SEXP kSEXP, SEXP threadsSEXP, SEXP rcpp_list_namesSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
