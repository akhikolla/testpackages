...
test_that("threads_fstlib(0) use all logical cores", {
  threads_fstlib(0)
  nr_of_threads <- threads_fstlib()
...
test_that("Set reset_after_fork", {
  ...
  expect_error(threads_fstlib(reset_after_fork = 3), "Parameter reset_after_fork should be set")
