...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_qmixcr");
    reader.add_event(72, 70, "end", "model_qmixcr");
    return reader;
}
...
class model_qmixcr
  : public stan::model::model_base_crtp<model_qmixcr> {
private:
        int N;
        int D;
        vector_d Y;
...
typedef model_qmixcr_namespace::model_qmixcr stan_model;
#ifndef USING_R
